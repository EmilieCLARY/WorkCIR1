...
\usepackage{pdfpages}           % pour inclure des pdfs
\usepackage{wrapfig}
...
\newcommand{\nomEntreprise}{Aéroport de Bordeaux-Mérignac}% Nom de l'entreprise
\newcommand{\lieuEntreprise}{Rue René Cassin, 33700 Mérignac}
